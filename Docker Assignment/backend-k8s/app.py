...
@app.route('/')
def index():
    return redirect("http://tutek8s.local/index.html");
...
def submit_form():
    ...
    try:
        ...
        return redirect('http://tutek8s.local/index.html', error=f"Error: {str(e)}")

@app.route('/success')
def success():
    """Display success message"""
    return redirect('http://tutek8s.local/success.html')
